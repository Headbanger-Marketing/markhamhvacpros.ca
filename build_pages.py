...
# ============================================================ DEPRECATED
"""Content + page assembly for markhamhvacpros.ca. Run: python3 build_pages.py"""
from build import *  # noqa

# ============================================================ SERVICE DETAILS
SVC = {
 "furnace-repair": {
   "icon":"flame", "kicker":"Furnace Repair in Markham, Ontario",
   "h1":"Fast, Reliable Furnace Repair to Keep Your Home Warm",
   "intro":"When your furnace stops working, you need fast, dependable service you can trust. At Markham HVAC Pros, we provide expert furnace repair in Markham, Ontario and surrounding York Region communities to restore warmth, safety, and efficiency to your home. Our skilled technicians quickly diagnose issues and deliver lasting repairs, helping you stay comfortable through every cold Ontario winter.",
   "meta":"Fast, reliable furnace repair in Markham, Ontario. Same-day service, emergency repairs & maintenance from licensed local technicians. Get a free quote.",
   "problem_h":"Furnace won't heat, makes noise, or won't start?",
   "problem_p":"Markham HVAC Pros provides expert furnace repair in Markham, ON to keep homes warm, safe, and efficient through the coldest months.",
   "features":[
     ...
     ("shield","Trusted, Local Experts You Can Count On","As a family-run HVAC company in Markham, our certified technicians repair all furnace brands, including high-efficiency systems, with honest pricing and clear communication."),
   ],
   "rev":[0,1,2],
 },
 "ac-repair": {
   "icon":"snowflake", "kicker":"AC Repair in Markham, ON",
   "h1":"Fast and Affordable AC Repair to Keep You Cool",
   "intro":"If your air conditioner isn't keeping up with the heat, Markham HVAC Pros is here to help with prompt, professional AC repair you can count on. We provide fast, affordable air conditioning repair in Markham and surrounding York Region communities, restoring comfort and efficiency when you need it most. Our experienced technicians diagnose problems quickly and deliver reliable solutions to keep your home cool all summer long.",
   "meta":"Fast, affordable AC repair in Markham, Ontario. Same-day air conditioning repair for central air & ductless systems from licensed local techs. Free quotes.",
   "problem_h":"AC not cooling, blowing warm air, or making noise?",
   "problem_p":"Markham HVAC Pros provides expert AC repair in Markham, ON for central air, ductless mini-splits, and high-efficiency systems.",
   "features":[
     ...
     ("shield","Trusted Local AC Experts","As a family-run HVAC company in Markham, our certified technicians service all AC makes and models with transparent pricing, fast response times, and long-lasting repairs."),
   ],
   "rev":[3,4,5],
 },
 "ductless-ac-installation": {
   "icon":"fan", "kicker":"Ductless AC Installation in Markham, Ontario",
   "h1":"Energy-Efficient Ductless Cooling, Custom-Fit to Your Home",
   "intro":"Experience reliable, energy-efficient cooling with professional ductless AC installation from Markham HVAC Pros. Serving Markham, Ontario and surrounding York Region areas, our expert technicians install high-performance ductless air conditioning systems that provide customizable comfort year-round. Ideal for homes without traditional ductwork, our solutions deliver quiet, efficient cooling while helping you save on energy costs.",
   "meta":"Professional ductless mini-split AC installation in Markham, Ontario. Energy-efficient, quiet cooling for homes without ductwork. Free quotes.",
   "problem_h":"Central air isn't practical without ductwork?",
   "problem_p":"Markham HVAC Pros provides ductless AC installation for efficient, flexible cooling that reduces energy costs and keeps every room comfortable.",
   "features":[
     ...
     ("shield","Trusted Local Installation Experts","As a family-run HVAC company in Markham, we deliver professional ductless AC installation with quality workmanship you can rely on for long-term energy savings."),
   ],
   "rev":[1,4,2],
 },
 "heat-pump-repair-installation": {
   "icon":"refresh", "kicker":"Heat Pump Repair &amp; Installation in Markham, ON",
   "h1":"Expert Heat Pump Services for Year-Round Comfort",
   "intro":"For reliable heat pump repair and installation in Markham, Ontario, trust the experienced team at Markham HVAC Pros. We provide expert heat pump services designed to keep your home efficient and comfortable in every season, from cold winters to hot, humid summers. Whether you need fast repairs, routine maintenance, or a new energy-efficient system, our skilled technicians deliver dependable solutions.",
   "meta":"Expert heat pump repair & installation in Markham, Ontario. Energy-efficient year-round heating and cooling from licensed local technicians. Free quotes.",
   "problem_h":"Heat pump won't heat, cool, or runs inefficiently?",
   "problem_p":"Markham HVAC Pros provides expert heat pump repair and installation in Markham, Ontario for reliable year-round comfort and lower energy bills.",
   "features":[
     ...
     ("shield","Trusted Local Heat Pump Experts","As a family-run HVAC company in Markham, our certified technicians repair and install all heat pump brands with transparent pricing and professional service."),
   ],
   "rev":[2,3,0],
 },
 "fireplace-installation": {
   "icon":"fireplace", "kicker":"Fireplace Installation in Markham, Ontario",
   "h1":"Beautiful and Safe Fireplace Installation",
   "intro":"Enhance your home's warmth and style with professional fireplace installation from Markham HVAC Pros. Serving Markham, Ontario and surrounding York Region areas, our skilled team ensures safe, efficient, and beautiful installations that complement any space. From modern gas units to classic wood-burning fireplaces, we provide expert guidance and quality workmanship to create a cozy, inviting atmosphere.",
   "meta":"Professional gas, electric & wood-burning fireplace installation in Markham, Ontario. Safe, code-compliant & beautifully integrated. Free quotes.",
   "problem_h":"Want to add warmth and a focal point to your home?",
   "problem_p":"Markham HVAC Pros provides professional fireplace installation, ensuring safe, efficient, code-compliant fireplaces beautifully integrated into your home.",
   "features":[
     ...
     ("award","Trusted Local Experts","As a family-run HVAC company in Markham, we deliver professional fireplace installation with transparent pricing, fast response, and exceptional craftsmanship."),
   ],
   "rev":[5,1,3],
 },
 "thermostat-repair-replacement": {
   "icon":"gauge", "kicker":"Thermostat Repair &amp; Replacement in Markham, Ontario",
   "h1":"Take Control of Your Home's Temperature",
   "intro":"Stay in control of your home's comfort with professional thermostat repair and replacement from Markham HVAC Pros. We provide expert thermostat services in Markham, Ontario and surrounding York Region areas, ensuring accurate temperature control, improved energy efficiency, and reliable system performance. Whether you need a quick repair, a smart-thermostat upgrade, or a full replacement, our technicians deliver dependable solutions.",
   "meta":"Thermostat repair & replacement in Markham, Ontario. Smart & programmable thermostat installation from licensed HVAC technicians. Free quote today.",
   ...
   "features":[
     ...
     ("shield","Trusted Local HVAC Experts","As a family-run HVAC company in Markham, our certified technicians repair and replace all thermostat brands with transparent pricing and reliable service."),
   ],
   "rev":[4,0,5],
 },
 "duct-cleaning": {
   "icon":"air-vent", "kicker":"Duct Cleaning in Markham, ON",
   "h1":"Improve Your Home's Air Quality with Professional Duct Cleaning",
   "intro":"Breathe easier with professional duct cleaning services from Markham HVAC Pros. We provide thorough air duct cleaning in Markham, Ontario and surrounding York Region communities to help remove dust, allergens, and buildup that affect your indoor air quality and system efficiency. Our experienced team uses advanced equipment to keep your HVAC system running smoothly while creating a cleaner, healthier home.",
   "meta":"Professional air duct cleaning in Markham, Ontario. Remove dust & allergens, improve airflow, lower energy costs. Free quote from licensed local experts.",
   "problem_h":"Dust, allergens, and weak airflow from your vents?",
   "problem_p":"Dust and debris in ductwork reduce air quality and HVAC efficiency. Our duct cleaning in Markham, Ontario improves airflow and supports healthier indoor air.",
   "features":[
     ...
     ("shield","Trusted Local Experts","As a family-run HVAC company in Markham, we provide reliable, professional duct cleaning with transparent pricing and healthier air for lasting home comfort."),
   ],
   "rev":[0,2,4],
 },
}
...
REVIEW_POOL = [
  ("They had our furnace running again the same day, on one of the coldest nights of the year. Fast and professional.","Mya C.","Markham"),
  ("Fixed the problem quickly and explained everything clearly. Great service from start to finish.","Daniel P.","Richmond Hill"),
  ("Reliable, affordable, and trustworthy. I won't call anyone else for HVAC.","Aisha N.","Newmarket"),
  ("Excellent response time and very knowledgeable technicians. Our home was comfortable again by morning.","Mark Z.","Aurora"),
  ("Professional service, fair pricing, and no surprises. They made the whole process simple and stress-free.","Kevin H.","Vaughan"),
  ("Friendly staff and outstanding workmanship. Our system runs better than ever after their visit.","Jennifer L.","Keswick"),
]
...
SVC_PHOTO_FALLBACK = ("wp/Markham-Ontario-HVAC-technician.png", "Markham HVAC Pros HVAC technician in service")
SVC_PHOTO = {
 "furnace-repair": ("wp/furnace-repair-1536x1024-2.png", "Furnace repair service"),
 "ac-repair": ("wp/Markham-Ontario-HVAC-technician.png", "Air conditioner repair service"),
 "ductless-ac-installation": ("wp/Markham-Ontario-HVAC-Contractor.png", "Ductless mini-split installation"),
 "heat-pump-repair-installation": ("wp/Markham-Ontario-HVAC-Contractor.png", "Heat pump repair and installation"),
 "fireplace-installation": ("wp/Markham-Ontario-HVAC-Contractor.png", "Fireplace installation"),
 "thermostat-repair-replacement": ("wp/Markham-Ontario-HVAC-technician.png", "Thermostat replacement"),
 "duct-cleaning": ("wp/Markham-Ontario-HVAC-technician.png", "Duct cleaning service"),
}
...
<section class="page-hero">
  <div class="container">
    ...
    <h1>Markham HVAC Pros, {data["h1"]}</h1>
    <p>{data["intro"]}</p>
...
<section class="section bg-soft">
  <div class="container">
    <div class="section-head reveal">
      ...
      <h2>What Markham Homeowners Say</h2>
...
{cta_band(title="We Can Help Solve Your "+nav_label.replace('&amp;','&')+" Needs",
          text="Don't let a comfort problem disrupt your home. Get fast, reliable service from Markham's trusted local HVAC team.")}
'''
    out += page_end()
    write(url, out)
...
HOME_FAQ = [
 ("How quickly can I get furnace repair in Markham, Ontario?","Our expert technicians provide fast, reliable furnace repair in Markham and surrounding York Region areas. We prioritize emergency service calls so your home heating is restored promptly, often the same day."),
 ("What types of AC repair services do you offer?","We offer comprehensive AC repair in Markham, including diagnostics, component replacement, and maintenance for central air conditioning and ductless mini-split systems to meet your cooling needs."),
 ...
 ("Can you repair or replace my thermostat?","Yes. We provide thermostat repair and replacement in Markham, including programmable and smart models, to optimize your heating and cooling performance and lower energy use."),
 ...
 ("Do you serve areas outside of Markham, Ontario?","Yes. We provide HVAC services throughout Markham and nearby communities including Pickering, Whitby, Oshawa, Bowmanville, and across York Region."),
...
def build_home():
    ...
    revs = "".join(review_card(*r) for r in [
      ("The team saved us with an emergency furnace repair in January. Professional, friendly, and they truly cared about our comfort.","Sarah M.","Markham"),
      ("Best team for HVAC! They helped us choose an energy-efficient AC system without upselling unnecessary equipment.","David R.","Richmond Hill"),
      ("Prompt, polite, and knowledgeable. They handled our heat pump installation with real pride. Highly recommend.","Jennifer T.","Newmarket"),
    ])
    blog_cards = build_blog_cards(BLOG)

    out = head(
      title=f"{SITE_NAME} | HVAC Company in {CITY}, ON",
      desc=f"Markham HVAC Pros provides honest, efficient, dependable HVAC service in {CITY}, Ontario, furnace & AC repair, heat pumps & more. Call {PHONE_DISPLAY} for a free quote.",
      path="/",
...
<section class="{hero_class()}">
  ...
  <div class="container">
    <div class="hero__copy reveal">
      ...
      <h1>Markham HVAC Pros, Expert Heating &amp; Cooling Repair in <span class="accent">{CITY}, ON</span></h1>
  ...
  <div class="container">
    <div class="split">
      <div class="reveal">
        ...
        <h2>Your Trusted Partner for Year-Round Comfort in Markham</h2>
        <p class="lead">At Markham HVAC Pros, we understand that a broken air conditioner or failing furnace is more than an inconvenience, it's a disruption to your life.</p>
        <p>As a local, family-run company, we specialize in heating and cooling solutions tailored to the Markham, Ontario climate. From maintaining your air conditioner through a humid July to fixing your furnace in the depths of January, our team provides honest advice and technical excellence on every visit.</p>
      ...
      <div class="split__media reveal d1">
        <img class="media-photo" src="/assets/img/wp/Markham-Ontario-HVAC-technician.png" alt="Markham HVAC Pros HVAC technician servicing a system" width="640" height="640" loading="lazy" decoding="async">
...
<section class="section bg-soft">
  <div class="container">
    <div class="section-head reveal">
      ...
      <h2>Comprehensive Heating &amp; Cooling Services in Markham</h2>
...
<section class="section">
  <div class="container">
    <div class="section-head reveal">
      ...
      <h2>Why Choose Markham HVAC Pros?</h2>
...
<section class="section bg-soft">
  <div class="container">
    <div class="section-head reveal">
      ...
      <h2>What Markham Homeowners Are Saying</h2>
...
<section class="section">
  <div class="container">
    <div class="section-head reveal">
      ...
      <p>Practical advice to help you get the most from your heating and cooling system in Markham's climate.</p>
    </div>
...
<section class="section bg-soft">
  <div class="container">
    <div class="section-head reveal">
      ...
      <p>Answers to the questions Markham homeowners ask us most.</p>
    </div>
...
def build_services_index():
    ...
    out = head(
      ...
      desc=f"Full-service heating & cooling in Markham, Ontario, furnace & AC repair, heat pumps, ductless AC, thermostats & duct cleaning. Free quotes.",
      path="/services/",
...
<section class="page-hero">
  <div class="container">
    ...
    <h1>Complete HVAC Services for Markham Homes</h1>
...
<section class="section bg-soft">
  <div class="container">
    <div class="steps">
      <div class="step reveal"><div class="step__ic">{icon('clock',size=26)}</div><div class="step__num"></div><h3>24/7 Emergency Service</h3><p>Heating and cooling failures don't wait for business hours. Our team is on call around the clock for Markham and York Region.</p></div>
...
def build_about():
    out = head(
      ...
      desc=f"Markham HVAC Pros is a local, family-run HVAC company serving Markham, Ontario with honest, reliable heating and cooling care. Meet the team.",
      path="/about/",
...
<section class="page-hero">
  <div class="container">
    ...
    <p>We aren't just technicians, we're your neighbours, committed to keeping Markham families comfortable through every season.</p>
  </div>
</section>
  ...
  <div class="container">
    <div class="split">
      <div class="reveal">
        ...
        <p>At Markham HVAC Pros, we believe every family deserves a comfortable, healthy home. As a family-oriented business based in Markham, Ontario, our mission is simple: keep your home comfortable through every season with the same high standard of care we'd expect for our own households.</p>
...
{cta_band(title="Experience the Markham HVAC Pros Difference",
...
def build_contact():
    out = head(
      ...
      desc=f"Contact Markham HVAC Pros for fast, friendly HVAC service in Markham, Ontario. Call {PHONE_DISPLAY} or request a free quote online. Open 24/7.",
      path="/contact/",
...
<section class="page-hero">
  <div class="container">
    ...
    <p>Is your air conditioner making a strange noise? Ready to upgrade your furnace before winter? Whatever your home comfort need, the Markham HVAC Pros team is ready to help, without the stress.</p>
  </div>
</section>
...
<section class="section">
  <div class="container">
    <div class="info-grid" style="margin-bottom:40px">
      ...
      <div class="info-card reveal d2"><span class="ic">{icon('pin',size=26)}</span><h3>Service Area</h3><p>{CITY}, {REGION}, {ADDR_POSTAL}</p><p style="color:var(--muted);font-size:.9rem;margin-top:4px">Serving Markham &amp; York Region</p></div>
    </div>
    <div class="split">
      <div class="reveal">
...
<section class="section bg-soft">
  <div class="container">
    ...
    <div class="info-grid">
      ...
      <div class="info-card center reveal d2"><span class="ic" style="margin-inline:auto">{icon('headset',size=26)}</span><h3>Real Local People</h3><p style="color:var(--muted)">Speak with a Markham technician</p></div>
    </div>
  </div>
</section>
...
# ============================================================ BLOG
BLOG = [
 {"slug":"how-often-should-you-service-your-hvac-system-in-markham-ontario",
  "title":"How Often Should You Service Your HVAC System in Markham, Ontario?",
  "seo_title":"How Often to Service Your HVAC in Markham, ON",
  "date":"2026-01-12","date_h":"January 12, 2026","img":"cool","icon":"calendar",
  "excerpt":"Markham's real seasons push your HVAC system hard. Here's how often you should service your furnace and AC, and why twice a year is the sweet spot.",
  "meta":"How often should you service your HVAC system in Markham, Ontario? Learn the ideal furnace and AC maintenance schedule for our climate from local experts.",
  "body":None},
 {"slug":"signs-your-furnace-needs-repair-before-a-markham-winter",
  "title":"Signs Your Furnace Needs Repair Before a Markham Winter",
  "seo_title":"Signs Your Furnace Needs Repair Before Winter",
  "date":"2026-02-15","date_h":"February 15, 2026","img":"warm","icon":"flame",
  "excerpt":"Don't wait for the coldest night of the year. Here are the most common warning signs your furnace needs repair before a Markham winter sets in.",
  "meta":"Five warning signs your furnace needs repair before a Markham, Ontario winter, strange noises, uneven heat, rising bills and more. Stay warm and safe.",
  "body":None},
 {"slug":"why-your-air-conditioner-struggles-during-humid-markham-summers",
  "title":"Why Your Air Conditioner Struggles During Humid Markham Summers",
  "seo_title":"Why Your AC Struggles in Humid Markham Summers",
  ...
  "meta":"Why does your air conditioner struggle in humid Markham summers? Learn how humidity affects cooling and what AC service near Lake Ontario can do to help.",
  "body":None},
]
...
def build_blog_index():
    ...
    out = head(
      ...
      desc="Practical heating and cooling advice for Markham, Ontario homeowners, maintenance schedules, furnace warning signs, humidity tips and more.",
      path="/blog/",
...
<section class="page-hero">
  <div class="container">
    ...
    <p>Straightforward advice to help you get the most out of your heating and cooling system in Markham's climate.</p>
  </div>
</section>
<section class="section">
  ...
  <div class="container">
    <article class="article reveal">{body_html}
      <div class="note-banner" style="margin-top:30px;background:var(--bg-alt);border:1px solid var(--line);color:var(--body)">
        ...
        <a href="/contact/">Request a free quote</a> and a local Markham technician will get back to you fast, we're here 24/7.
      </div>
    </article>
  </div>
</section>
...
def blog_bodies():
    return {
 "how-often-should-you-service-your-hvac-system-in-markham-ontario": '''
<p class="lead">Living in Markham, Ontario means dealing with real seasons. Winter can be bitterly cold, and summer near Lake Ontario brings long stretches of heat and humidity. Your HVAC system doesn't get much of a break, which is exactly why regular maintenance matters.</p>
<p>At Markham HVAC Pros, we often hear the same question: <em>how often should I service my heating and cooling system?</em> Our answer is simple. At minimum, twice per year.</p>
...
<p>Before the hot weather hits Markham, your air conditioner should be inspected and cleaned. After sitting idle all winter, components may need attention. A spring tune-up ensures your system is ready to handle long, humid days without struggling.</p>
...
<h2>Book Your Service With Markham HVAC Pros</h2>
<p>We're proud to serve homeowners throughout Markham and the surrounding York Region area. As a local, family-operated company, we focus on honest service and long-term relationships with our customers. If it has been more than a year since your last HVAC service, now is the time to schedule.</p>
''',
 "signs-your-furnace-needs-repair-before-a-markham-winter": '''
<p class="lead">Winter in Markham, Ontario is serious business. When temperatures fall well below freezing and the wind comes off Lake Ontario, your furnace becomes the heart of your home. It keeps your family warm, protects your plumbing from freezing, and makes everyday life comfortable.</p>
...
<p>Do you notice that some rooms feel warm while others stay cold? Uneven heating is one of the most common complaints we hear from homeowners in Markham.</p>
...
<h2>Need Furnace Repair in Markham, Ontario?</h2>
<p>At Markham HVAC Pros, we understand how important reliable heat is for your home and family. As a local, family-operated HVAC company, we provide fast, dependable furnace repair throughout Markham and nearby York Region communities. If you've noticed any of these warning signs, don't wait for winter to put your system to the test.</p>
''',
 "why-your-air-conditioner-struggles-during-humid-markham-summers": '''
<p class="lead">If your air conditioner seems to run all day but your home still feels sticky and uncomfortable, you're not imagining it. Summers in Markham, Ontario aren't just hot, they're humid. Sitting close to Lake Ontario, our area sees moisture levels that play a major role in how comfortable your home feels, even when the temperature looks fine.</p>
...
<ul class="bullets">
  ...
  <li><strong>An undersized system.</strong> If the unit wasn't properly sized during installation, it may struggle during peak summer conditions in Markham.</li>
</ul>
...
<h2>Schedule AC Service in Markham Today</h2>
<p>At Markham HVAC Pros, we understand how challenging Ontario summers can be. As a family-owned and operated HVAC company, we provide honest, reliable air conditioning repair and maintenance throughout Markham and the surrounding York Region area. If your home feels humid or your AC is struggling to keep up, we'll help restore comfort and keep your cooling system running efficiently all summer long.</p>
''',
    }
...
def build_privacy():
    out = head(title=f"Privacy Policy | {SITE_NAME}",
      desc="Privacy policy for Markham HVAC Pros, how we collect, use, and protect your personal information.",
      path="/privacy-policy/",
...
def build_root_files():
    write_root("CNAME", "markhamhvacpros.ca\n")
