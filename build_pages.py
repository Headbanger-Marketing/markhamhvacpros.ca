...
SVC_PHOTO_FALLBACK = ("wp/London-Ontario-HVAC-technician.png", "Markham HVAC Pros HVAC technician in service")
SVC_PHOTO = {
  ...
  <div class="container">
    <div class="split">
      ...
      <div class="split__media reveal d1">
        <img class="media-photo" src="/assets/img/wp/London-Ontario-HVAC-technician.png" alt="Markham HVAC Pros HVAC technician servicing a system" width="640" height="640" loading="lazy" decoding="async">
