...
SVC = {
 "furnace-repair": {
   ...
   "intro":"When your furnace stops working, you need fast, dependable service you can trust. At Markham Heating &amp; Cooling, we provide expert furnace repair in Markham, Ontario and surrounding York Region communities to restore warmth, safety, and efficiency to your home. Our skilled technicians quickly diagnose issues and deliver lasting repairs, helping you stay comfortable through every cold Ontario winter.",
   ...
   "problem_p":"Markham Heating &amp; Cooling provides expert furnace repair in Markham, ON to keep homes warm, safe, and efficient through the coldest months.",
   "features":[
 ...
 "ac-repair": {
   ...
   "problem_p":"Markham Heating &amp; Cooling provides expert AC repair in Markham, ON for central air, ductless mini-splits, and high-efficiency systems.",
   "features":[
 ...
 "ductless-ac-installation": {
   ...
   "intro":"Experience reliable, energy-efficient cooling with professional ductless AC installation from Markham Heating &amp; Cooling. Serving Markham, Ontario and surrounding York Region areas, our expert technicians install high-performance ductless air conditioning systems that provide customizable comfort year-round. Ideal for homes without traditional ductwork, our solutions deliver quiet, efficient cooling while helping you save on energy costs.",
   ...
   "problem_p":"Markham Heating &amp; Cooling provides ductless AC installation for efficient, flexible cooling that reduces energy costs and keeps every room comfortable.",
   "features":[
 ...
 "heat-pump-repair-installation": {
   ...
   "intro":"For reliable heat pump repair and installation in Markham, Ontario, trust the experienced team at Markham Heating &amp; Cooling. We provide expert heat pump services designed to keep your home efficient and comfortable in every season — from cold winters to hot, humid summers. Whether you need fast repairs, routine maintenance, or a new energy-efficient system, our skilled technicians deliver dependable solutions.",
   ...
   "problem_p":"Markham Heating &amp; Cooling provides expert heat pump repair and installation in Markham, Ontario for reliable year-round comfort and lower energy bills.",
   "features":[
 ...
 "fireplace-installation": {
   ...
   "intro":"Enhance your home's warmth and style with professional fireplace installation from Markham Heating &amp; Cooling. Serving Markham, Ontario and surrounding York Region areas, our skilled team ensures safe, efficient, and beautiful installations that complement any space. From modern gas units to classic wood-burning fireplaces, we provide expert guidance and quality workmanship to create a cozy, inviting atmosphere.",
   ...
   "problem_p":"Markham Heating &amp; Cooling provides professional fireplace installation, ensuring safe, efficient, code-compliant fireplaces beautifully integrated into your home.",
   "features":[
 ...
 "thermostat-repair-replacement": {
   ...
   "intro":"Stay in control of your home's comfort with professional thermostat repair and replacement from Markham Heating &amp; Cooling. We provide expert thermostat services in Markham, Ontario and surrounding York Region areas, ensuring accurate temperature control, improved energy efficiency, and reliable system performance. Whether you need a quick repair, a smart-thermostat upgrade, or a full replacement, our technicians deliver dependable solutions.",
...
<section class="page-hero">
  <div class="container">
    ...
    <h1>Markham Heating & Cooling — {data["h1"]}</h1>
    <p>{data["intro"]}</p>
...
def build_home():
    ...
    out = head(
      ...
      desc=f"Markham Heating & Cooling provides honest, efficient, dependable HVAC service in {CITY}, Ontario — furnace & AC repair, heat pumps & more. Call {PHONE_DISPLAY} for a free quote.",
      path="/",
...
<section class="{hero_class()}">
  ...
  <div class="container">
    <div class="hero__copy reveal">
      ...
      <h1>Markham Heating & Cooling — Expert Heating &amp; Cooling Repair in <span class="accent">{CITY}, ON</span></h1>
  ...
  <div class="container">
    <div class="split">
      <div class="reveal">
        ...
        <p class="lead">At Markham Heating &amp; Cooling, we understand that a broken air conditioner or failing furnace is more than an inconvenience — it's a disruption to your life.</p>
        ...
        <div class="media-panel">
          <div class="media-panel__row">
            ...
            <div class="media-chip media-chip--wide cool" style="display:flex;align-items:center;gap:14px">
              ...
              <div><b>Real local technicians, on call 24/7</b><span>Serving Markham &amp; York Region, every day of the year</span></div>
            </div>
          </div>
        </div>
      </div>
...
<section class="section">
  <div class="container">
    <div class="section-head reveal">
      ...
      <h2>Why Choose Markham Heating &amp; Cooling?</h2>
...
def build_about():
    out = head(
      ...
      desc=f"Markham Heating & Cooling is a local, family-run HVAC company serving Markham, Ontario with honest, reliable heating and cooling care. Meet the team.",
      path="/about/",
  ...
  <div class="container">
    <div class="split">
      <div class="reveal">
        ...
        <p>At Markham Heating &amp; Cooling, we believe every family deserves a comfortable, healthy home. As a family-oriented business based in Markham, Ontario, our mission is simple: keep your home comfortable through every season with the same high standard of care we'd expect for our own households.</p>
...
{cta_band(title="Experience the Markham Heating &amp; Cooling Difference",
...
def build_contact():
    out = head(
      ...
      desc=f"Contact Markham Heating & Cooling for fast, friendly HVAC service in Markham, Ontario. Call {PHONE_DISPLAY} or request a free quote online. Open 24/7.",
      path="/contact/",
...
<section class="page-hero">
  <div class="container">
    ...
    <p>Is your air conditioner making a strange noise? Ready to upgrade your furnace before winter? Whatever your home comfort need, the Markham Heating &amp; Cooling team is ready to help — without the stress.</p>
  </div>
</section>
...
<p>At Markham Heating &amp; Cooling, we often hear the same question: <em>how often should I service my heating and cooling system?</em> Our answer is simple. At minimum, twice per year.</p>
...
<h2>Book Your Service With Markham Heating &amp; Cooling</h2>
...
def build_privacy():
    out = head(title=f"Privacy Policy | {SITE_NAME}",
      desc="Privacy policy for Markham Heating & Cooling — how we collect, use, and protect your personal information.",
      path="/privacy-policy/",
